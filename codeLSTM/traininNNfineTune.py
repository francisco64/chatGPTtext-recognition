...
data_train=tf.data.TFRecordDataset(glob.glob('/home/francisco/Documents/statMLa1/simpleNN/undersampling/train_dom2_*.record'))

data_val=tf.data.TFRecordDataset(glob.glob('/home/francisco/Documents/statMLa1/simpleNN/undersampling/val_dom2_*.record'))#check if it is better use a falanced version of the dataset that has participation of both domains or a metric that outweights both domains
...
model=classifier()
model.load_weights('/home/francisco/Documents/statMLa1/simpleNN/simple/checkpoint/model.31.h5')
